...
export default function AdminLayout({ children, darkMode, toggleDarkMode }) {
  ...
  const handleLogout = () => {
    ...
    sessionStorage.removeItem("departmentAdminMain");
    sessionStorage.removeItem("mainAdminDoersName");
    sessionStorage.removeItem("mainAdminGivenBy");
  ...
  const dataCategories = [
    { id: "main", name: "Main", link: "/dashboard/data/main" },
    { id: "sales", name: "Housekeeping", link: "/dashboard/data/sales" },
    { id: "service", name: "Security", link: "/dashboard/data/service" },
    { id: "jockey", name: "Laboratory", link: "/dashboard/data/jockey" },
    { id: "account", name: "Accounts", link: "/dashboard/data/account" },
    { id: "warehouse", name: "Maintenance", link: "/dashboard/data/warehouse" },
    { id: "purchase", name: "MGMT", link: "/dashboard/data/purchase" },
    { id: "director", name: "HR", link: "/dashboard/data/director" },
    {
      id: "managing-director",
      name: "Operation",
      link: "/dashboard/data/managing-director",
    },
    {
      id: "general-ward",
      name: "General Ward",
      link: "/dashboard/data/general-ward",
    },
    {
      id: "private-ward",
      name: "Private Ward",
      link: "/dashboard/data/private-ward",
    },
    {
      id: "supervisor",
      name: "Supervisor",
      link: "/dashboard/data/supervisor",
    },
    ...
    { id: "nicu", name: "NICU", link: "/dashboard/data/nicu" },
    { id: "hdu", name: "HDU", link: "/dashboard/data/hdu" },
    { id: "picu", name: "PICU", link: "/dashboard/data/picu" },
    { id: "rmo", name: "RMO", link: "/dashboard/data/rmo" },
    { id: "tpa", name: "TPA", link: "/dashboard/data/tpa" },
    { id: "it", name: "IT", link: "/dashboard/data/it" },
    { id: "crm", name: "CRM", link: "/dashboard/data/crm" },
    { id: "ea", name: "EA", link: "/dashboard/data/ea" },
    {
      id: "telecaller",
      name: "Telecaller",
      link: "/dashboard/data/telecaller",
    },
    ...
    // ✅ ADD ALL THE MISSING PAGES:
    {
      id: "nurshing-staff",
      name: "Nursing Staff",
      link: "/dashboard/data/nurshing-staff",
    },
    {
      id: "nurshing-incharge",
      name: "Nursing Incharge",
      link: "/dashboard/data/nurshing-incharge",
    },
    ...
    { id: "icn", name: "ICN", link: "/dashboard/data/icn" },
    {
      id: "storekeeper",
      name: "Storekeeper",
      link: "/dashboard/data/storekeeper",
    },
    {
      id: "nurshing-superintendent",
      name: "Nursing Superintendent",
      link: "/dashboard/data/nurshing-superintendent",
    },
    {
      id: "sr-incharge",
      name: "Sr Incharge",
      link: "/dashboard/data/sr-incharge",
    },
  ...
  const routes = [
    {
      ...
      showFor: ["admin", "main admin", "user"], // Show for both roles
    },
    {
      ...
      showFor: ["admin", "main admin"], // Only show for admin
    },
    {
      ...
      showFor: ["admin", "user", "main admin"], // Only show for admin
    },
    {
      href: "#",
      label: "Data",
      ...
      submenu: true,
      showFor: ["admin", "user", "main admin"], // Show for both roles
    },
  ];
              ...
              <li key={route.label}>
                {route.submenu ? (
                  <div>
                    ...
                    {isDataSubmenuOpen && sessionStorage.getItem('role') !== "main admin" && (
