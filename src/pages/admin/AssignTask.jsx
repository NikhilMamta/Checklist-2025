  ...
  const [formData, setFormData] = useState({
    department:
      sessionStorage.getItem("role") === "main admin"
        ? sessionStorage.getItem("departmentAdminMain")
        : "",
    givenBy: sessionStorage.getItem("role") === "main admin" ? sessionStorage.getItem("mainAdminGivenBy") : "",
    doer: sessionStorage.getItem("role") === "main admin" ? sessionStorage.getItem("mainAdminDoersName") : "",
    description: "",
    frequency: "daily",
    ...
    try {
      ...
      data.table.rows.slice(1).forEach((row) => {
        ...
        if (row.c && row.c[2] && row.c[2].v) {
          ...
          const department =
            row.c && row.c[5] && row.c[5].v ? row.c[5].v.toString().trim() : ""; // Column F (index 5)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const submitSheetName =
        formData.frequency === "one-time" ? "DELEGATION" : formData.department;
      ...
      alert(
        `Successfully submitted ${generatedTasks.length} tasks to ${submitSheetName} sheet in one batch!`
      );
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full rounded-md border border-purple-200 p-2 focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500 cursor-not-allowed" value={formData.department}  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full rounded-md border border-purple-200 p-2 focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500 cursor-not-allowed" value={formData.givenBy}  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full rounded-md border border-purple-200 p-2 focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500 cursor-not-allowed" value={formData.doer}  />
                </div>
